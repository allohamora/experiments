...
const smoothScroll = (a, hash) => {
  ...
  animate(from, to).then(() => replaceHash(hash), noop); // noop need for remove promise reject error on cancel animation
};
...
const createInit = (smoothScrollFn) => () =>
